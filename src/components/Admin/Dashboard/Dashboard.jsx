...
const Dashboard = () => {
    return <Grid css={{ cursor: `url(${cursor}), default` }} minH={"100vh"} templateColumns={["1fr", "5fr 1fr"]} >
        <Box boxSizing='border-box' px={["4", "0"]} py="16">
            <Text textAlign={"center"} opacity={0.5} children={`Last change was on ${String(new Date()).split("G")[0]}`} ></Text>
            ...
            <Stack direction={["column", "row"]} minH="24" justifyContent={"space-evenly"} >
                ...
                <Databox title="Subscription" qty={3} qtyPercentage={20} profit={false} />
